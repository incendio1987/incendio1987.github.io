...
function GridCell(props) {
  ...
  var pal = props.pal;
  var onLightbox = props.onLightbox;
  ...
  var handleClick = function() {
    ...
    if (!('ontouchstart' in window)) {
      if (onLightbox) onLightbox(project);
    } else {
      if (hovered) {
        if (onLightbox) onLightbox(project);
      }
  ...
  var handleTouchEnd = function(e) {
    ...
    if (dt < 300) {
      ...
      if (!hovered) {
        ...
        // Second tap on visible thumbnail: open lightbox
        if (onLightbox) onLightbox(project);
      }
    }
  };
...
function HomeV2() {
  ...
  var _lb = React.useState(null);
  var lightbox = _lb[0], setLightbox = _lb[1];

  /* Close lightbox on Escape */
  React.useEffect(function() {
    var handler = function(e) { if (e.key === "Escape") setLightbox(null); };
...
\n\
    ...
    .ih-lightbox .lb-close:hover { background: var(--ink); color: var(--paper); }\n\
    .ih-lightbox .lb-card {\n\
      position: relative;\n\
      ...
      background: var(--paper);\n\
      display: flex; flex-direction: column;\n\
      animation: lbPop 0.3s cubic-bezier(0.34,1.4,0.64,1);\n\
      cursor: default;\n\
    }\n\
    @keyframes lbPop { from { transform: scale(0.92); opacity: 0; } to { transform: scale(1); opacity: 1; } }\n\
    .ih-lightbox .lb-img {\n\
      flex: 1; min-height: 0;\n\
      display: flex; align-items: center; justify-content: center;\n\
      overflow: hidden;\n\
    }\n\
    .ih-lightbox .lb-img img {\n\
    ...
    .ih-lightbox .lb-meta .t { font-size: 14px; letter-spacing: 0.04em; }\n\
    .ih-lightbox .lb-meta .c { font-size: 8px; letter-spacing: 0.2em; opacity: 0.5; }\n\
    .ih-lightbox .lb-go {\n\
      display: inline-block; margin-top: 0; padding: 0 0 0 12px;\n\
      font-size: 9px; letter-spacing: 0.15em; opacity: 0.6;\n\
      cursor: pointer; transition: opacity 0.2s;\n\
    }\n\
    .ih-lightbox .lb-go:hover { opacity: 1; color: var(--a1); }\n\
  ";
  ...
  return React.createElement("div", { className: "incendio-home" },
    ...
    lightbox ? React.createElement("div", {
      ...
      React.createElement("div", {
        ...
        React.createElement("div", { className: "lb-img" },
          React.createElement("img", { src: lightbox.cover, alt: lightbox.title })
        ),
        React.createElement("div", { className: "lb-meta" },
          React.createElement("span", { className: "t" }, lightbox.title),
          React.createElement("span", { className: "c" },
            lightbox.cat + (lightbox.year ? " \u00B7 " + lightbox.year : ""),
            React.createElement("a", {
              className: "lb-go",
              onClick: function() { window.location.hash = "#/project/" + lightbox.id; setLightbox(null); }
            }, "VER PROYECTO \u2192")
          )
        )
      )
