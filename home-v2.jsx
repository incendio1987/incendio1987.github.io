  ...
  return (
    <div className="h2">
      ...
      <header className="h2-top">
        ...
        <nav>
          <a className="active" href="#/">{t("work")}</a>
          <a href="#/shop">{t("shop").toUpperCase()}</a>
      ...
      <section className="h2-bonitas">
        ...
        <div className="h2-carousel-controls">
          ...
          <a className="all" href="#/category/all">{t("ver_favoritos")}</a>
        </div>
      </section>
        ...
        <div className="h2-cats">
          {browseCats.map(c => (
            <a className="h2-cat" key={c.id}
               href={c.isPage ? `#/${c.id}` : `#/category/${c.id}`}
